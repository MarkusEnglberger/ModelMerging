...
Pretrained      & alone      & $0$ & $0$ & $0$ & $0.550\ ({+}.10)$ \\
                ...
                & $+$APR     & $\mathbf{0.315}^{\dagger}\ ({-}.12)$ & $\mathbf{0.432}^{\dagger}\ ({-}.16)$ & $\mathbf{0.508}^{\dagger}\ ({+}.03)$ & $\mathbf{0.647}\ ({+}.22)$ \\
\midrule
Task arithmetic & alone      & $0.320\ ({-}.18)$ & $0.270\ ({-}.53)$ & $0.352\ ({-}.50)$ & --- \\
                & $+$GD      & $0.574^{\dagger}\ ({+}.06)$ & $0.424^{\dagger}\ ({-}.26)$ & $0.660^{\dagger}\ ({+}.33)$ & --- \\
                & $+$ungated & $0.586\ ({-}.01)$ & $0.450^{\dagger}\ ({-}.25)$ & $0.538\ ({-}.33)$ & --- \\
                & $+$APR     & $0.608\ ({+}.10)$ & $0.516^{\dagger}\ ({-}.08)$ & $0.581\ ({+}.05)$ & --- \\
\midrule
Breadcrumbs     & alone      & $0.030\ ({-}2.14)$ & $0.431\ ({+}.08)$ & $0.409\ ({+}.00)$ & --- \\
                & $+$GD      & $0.534^{\dagger}\ ({+}.04)$ & $0.511^{\dagger}\ ({+}.09)$ & $0.658^{\dagger}\ ({+}.05)$ & --- \\
                & $+$ungated & $0.563\ ({+}.04)$ & $0.491^{\dagger}\ ({-}.03)$ & $0.563\ ({-}.27)$ & --- \\
                & $+$APR     & $0.567^{\dagger}\ ({+}.04)$ & $0.505^{\dagger}\ ({+}.07)$ & $0.552^{\dagger}\ ({+}.08)$ & --- \\
\midrule
DARE-TIES       & alone      & $0.301\ ({-}.34)$ & $0.364\ ({-}.32)$ & $0.371\ ({-}.42)$ & --- \\
                & $+$GD      & $0.521\ ({-}.08)$ & $0.506^{\dagger}\ ({-}.07)$ & $0.690^{\dagger}\ ({+}.38)$ & --- \\
                & $+$ungated & $0.574\ ({+}.09)$ & $0.269^{\dagger}\ ({-}2.10)$ & $0.622\ ({+}.08)$ & --- \\
                & $+$APR     & $0.586\ ({+}.11)$ & $0.488^{\dagger}\ ({-}.71)$ & $0.653^{\dagger}\ ({+}.15)$ & --- \\
\midrule
TIES            & alone      & $0.208\ ({-}.22)$ & $0.525\ ({+}.21)$ & $0.418\ ({-}.17)$ & --- \\
                & $+$GD      & $0.516^{\dagger}\ ({-}.13)$ & $\mathbf{0.599}^{\dagger}\ ({+}.21)$ & $\mathbf{0.716}^{\dagger}\ ({+}.39)$ & --- \\
                & $+$ungated & $0.525^{\dagger}\ ({-}.08)$ & $0.562^{\dagger}\ ({-}.28)$ & $0.606\ ({+}.00)$ & --- \\
                & $+$APR     & $0.543^{\dagger}\ ({-}.03)$ & $0.539^{\dagger}\ ({-}.38)$ & $0.657^{\dagger}\ ({+}.09)$ & --- \\
\midrule
AdaMerging      & alone      & --- & --- & --- & --- \\
                & $+$GD      & --- & --- & --- & --- \\
                & $+$ungated & --- & --- & --- & --- \\
...
Once a good merge \emph{is} available, the gate no longer wins on mean retention, and the outcome is benchmark-dependent. APR is the better treatment in all four composition rows on GLUE-8 (best $0.608$), in one of four on CLIP-8, and in none on the shared-output track, where ordinary replay GD from TIES is the strongest cell in the table ($0.716$ vs.\ APR's $0.657$). We read this as a statement about where the anchor is binding rather than as a refutation: a strong merge already lies inside the region where unconstrained descent is well behaved, so constraining the step costs more than it saves, whereas the pretrained model does not. Two caveats keep this from being a clean loss for the gate. Mean retention does not price tail risk, and Table~\ref{tab:t5budget} shows descent on this very track collapsing on two of three replay draws at these budgets---a hazard invisible to any single-draw number. And APR's outcome is far less sensitive to which merge it is given on CLIP-8 (a $0.051$ spread across initializations, against $0.175$ for GD), though not on the other two, where the spreads are comparable. The defensible claim is therefore narrower than ``APR is best'': the gated anchor is what makes replay refinement work \emph{without} a good merge, and what bounds its downside \emph{with} one.
