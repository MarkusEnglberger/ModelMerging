...
\item \emph{Checkpoint-only construction}: task arithmetic, TIES, DARE-TIES, Breadcrumbs, and DOGE/APGD; the labels influence nothing beyond the choice among a handful of candidates.
