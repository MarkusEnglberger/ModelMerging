...
Pretrained      & alone      & $0$ & $0$ & $0.289\ (.06)$ & --- \\
                ...
                & $+$APR     & $0.223^{\dagger}\ ({-}.33)$ & $0.295^{\dagger}\ ({-}.45)$ & $0.337\ (.20)$ & --- \\
\midrule
Task arithmetic & alone      & $0.320\ ({-}.18)$ & $0.270\ ({-}.53)$ & $0.469\ (.33)$ & --- \\
                & $+$GD      & $0.530\ ({+}.04)$ & $0.167^{\dagger}\ ({-}1.10)$ & --- & --- \\
                & $+$ungated & $0.529\ ({+}.03)$ & $0.241^{\dagger}\ ({-}.79)$ & --- & --- \\
                & $+$APR     & $0.498\ ({-}.18)$ & $0.462^{\dagger}\ ({-}.12)$ & $0.477\ (.36)$ & --- \\
\midrule
Breadcrumbs     & alone      & $0.030\ ({-}2.14)$ & $0.431\ ({+}.08)$ & $0.416\ (.25)$ & --- \\
                & $+$GD      & $0.512\ ({-}.00)$ & $0.479^{\dagger}\ ({+}.04)$ & --- & --- \\
                & $+$ungated & $0.536\ ({+}.05)$ & $0.391^{\dagger}\ ({-}.40)$ & --- & --- \\
                & $+$APR     & $0.528\ ({-}.06)$ & $0.339^{\dagger}\ ({-}.46)$ & $0.414\ (.31)$ & --- \\
\midrule
DARE-TIES       & alone      & $0.301\ ({-}.34)$ & $0.364\ ({-}.32)$ & $0.490\ (.35)$ & --- \\
                & $+$GD      & $0.484\ ({-}.08)$ & $-1.273^{\dagger}\ ({-}4.87)$ & --- & --- \\
                & $+$ungated & $0.534\ ({+}.08)$ & $-0.578\ ({-}3.11)$ & --- & --- \\
                & $+$APR     & $\mathbf{0.576}\ ({+}.19)$ & $0.498^{\dagger}\ ({-}.31)$ & $\mathbf{0.508}\ (\mathbf{.39})$ & --- \\
\midrule
TIES            & alone      & $0.208\ ({-}.22)$ & $0.525\ ({+}.21)$ & $0.464\ (.36)$ & --- \\
                & $+$GD      & $0.442\ ({-}.10)$ & $\mathbf{0.585}^{\dagger}\ ({+}.18)$ & --- & --- \\
                & $+$ungated & $0.442\ ({-}.07)$ & $0.318^{\dagger}\ ({-}1.57)$ & --- & --- \\
                & $+$APR     & $0.489^{\dagger}\ ({+}.01)$ & $0.566^{\dagger}\ ({-}.08)$ & $0.467\ (.37)$ & --- \\
\midrule
AdaMerging      & alone      & $0.028\ ({-}3.01)$ & $0.463\ ({-}.04)$ & $0.496\ (.36)$ & --- \\
                & $+$GD      & $0.016\ ({-}2.95)$ & $0.502^{\dagger}\ ({-}.06)$ & --- & --- \\
                & $+$ungated & $0.466\ ({-}.10)$ & $0.285^{\dagger}\ ({-}1.41)$ & --- & --- \\
                & $+$APR     & $0.543\ ({+}.02)$ & $0.554^{\dagger}\ ({+}.15)$ & $0.497\ (.39)$ & --- \\
\midrule
RegMean         & alone      & --- & --- & --- & --- \\
                & $+$GD      & --- & --- & --- & --- \\
                & $+$ungated & --- & --- & --- & --- \\
