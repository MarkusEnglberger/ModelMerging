...
Pretrained      & alone      & $0$ & $0$ & $0$ & $0.550\ ({+}.10)$ \\
                ...
                & $+$APR     & $0.315^{\dagger}\ ({-}.12)$ & $0.432^{\dagger}\ ({-}.16)$ & $0.508^{\dagger}\ ({+}.03)$ & $\mathbf{0.647}\ ({+}.22)$ \\
\midrule
Task arithmetic & alone      & $0.320\ ({-}.18)$ & $0.270\ ({-}.53)$ & $0.352\ ({-}.50)$ & --- \\
                & $+$GD      & $0.574\ ({+}.06)$ & $0.425^{\dagger}\ ({-}.31)$ & $0.660\ ({+}.33)$ & --- \\
                & $+$ungated & $0.586\ ({-}.01)$ & $0.450\ ({-}.25)$ & $0.538\ ({-}.33)$ & --- \\
                & $+$APR     & $\mathbf{0.608}\ ({+}.10)$ & $0.524^{\dagger}\ ({-}.01)$ & $0.534\ ({+}.08)$ & --- \\
\midrule
Breadcrumbs     & alone      & $0.030\ ({-}2.14)$ & $0.431\ ({+}.08)$ & $0.409\ ({+}.00)$ & --- \\
                & $+$GD      & $0.534\ ({+}.04)$ & $0.513^{\dagger}\ ({+}.07)$ & $0.658\ ({+}.05)$ & --- \\
                & $+$ungated & $0.563\ ({+}.04)$ & $0.487^{\dagger}\ ({-}.04)$ & $0.563\ ({-}.27)$ & --- \\
                & $+$APR     & $0.567\ ({+}.04)$ & $0.504^{\dagger}\ ({+}.06)$ & $0.564^{\dagger}\ ({+}.10)$ & --- \\
\midrule
DARE-TIES       & alone      & $0.301\ ({-}.34)$ & $0.364\ ({-}.32)$ & $0.371\ ({-}.42)$ & --- \\
                & $+$GD      & $0.521\ ({-}.08)$ & $0.515^{\dagger}\ ({-}.07)$ & $0.651^{\dagger}\ ({+}.33)$ & --- \\
                & $+$ungated & $0.574\ ({+}.09)$ & $0.284^{\dagger}\ ({-}1.99)$ & $0.489\ ({-}.17)$ & --- \\
                & $+$APR     & $0.586\ ({+}.11)$ & $0.506^{\dagger}\ ({-}.58)$ & $0.662\ ({+}.20)$ & --- \\
\midrule
TIES            & alone      & $0.208\ ({-}.22)$ & $0.525\ ({+}.21)$ & $0.418\ ({-}.17)$ & --- \\
                & $+$GD      & $0.516\ ({-}.13)$ & $0.599^{\dagger}\ ({+}.21)$ & $\mathbf{0.716}\ ({+}.39)$ & --- \\
                & $+$ungated & $0.525\ ({-}.08)$ & $0.564^{\dagger}\ ({-}.23)$ & $0.606\ ({+}.00)$ & --- \\
                & $+$APR     & $0.543\ ({-}.03)$ & $0.548^{\dagger}\ ({-}.27)$ & $0.575\ ({+}.17)$ & --- \\
\midrule
AdaMerging      & alone      & $0.029\ ({-}3.02)$ & $0.533\ ({+}.09)$ & --- & --- \\
                & $+$GD      & $0.459^{\dagger}\ ({-}.35)$ & $0.601^{\dagger}\ ({+}.16)$ & --- & --- \\
                & $+$ungated & $0.538\ ({-}.36)$ & $0.569^{\dagger}\ ({-}.06)$ & --- & --- \\
                & $+$APR     & $0.564\ ({-}.02)$ & $\mathbf{0.639}^{\dagger}\ ({+}.30)$ & --- & --- \\
\midrule
RegMean         & alone      & --- & --- & --- & --- \\
                & $+$GD      & --- & --- & --- & --- \\
                & $+$ungated & --- & --- & --- & --- \\
...
Once a good merge \emph{is} available the margins narrow sharply and the ordering becomes benchmark-dependent. On GLUE-8 the gate still wins cleanly: APR is the better treatment in all five composition rows, and its best cell ($0.608$, from task arithmetic) leads the best GD cell by $0.034$. On CLIP-8 the row-by-row comparison favors GD (APR better in two of five), yet the best composition cell is still APR's ($0.639$ from AdaMerging, against $0.601$)---the gate loses the typical row and wins the top one, because it composes best with the strongest initialization. On the shared-output track the gate loses outright: GD from TIES is the strongest cell in the table ($0.716$), ahead of APR's best ($0.662$) and better than APR in three of four rows.

We read this as a statement about where the anchor binds rather than as a refutation. A strong merge already lies inside the region where unconstrained descent is well behaved, so constraining the step costs more than it saves; the pretrained model does not, which is why the same constraint is decisive there. Two things keep the composition tier from being a clean loss for the gate. Mean retention does not price tail risk, and Table~\ref{tab:t5budget} shows descent on this very track collapsing to the degenerate attractor on two of three replay draws at these budgets---a hazard no single-draw number can show. And APR's result is less sensitive to which merge it is handed on two of the three benchmarks (spreads across initializations of $0.065$ vs.\ $0.115$ on GLUE-8 and $0.135$ vs.\ $0.176$ on CLIP-8, though $0.128$ vs.\ $0.065$ against it on the shared-output track). The defensible claim is therefore narrower than ``APR is best'': the gated anchor is what makes replay refinement work \emph{without} a good merge, and what bounds its downside \emph{with} one.
