...
TIES                       & $0.735\pm0.006$ & $0.522\pm0.016$ & $0.549\pm0.000$ & $0.234\pm0.000$ \\
$\thetab+$GD (ablation)      & $0.564\pm0.002$ & $0.391\pm0.018$ & $0.521\pm0.017$ & $0.111\pm0.068$ \\
$\thetab+$ungated (ablation) & $0.579\pm0.008$ & $0.440\pm0.013$ & $0.480\pm0.060$ & $0.115\pm0.074$ \\
$\thetab+$APR                & $\mathbf{0.751}\pm0.004$ & $\mathbf{0.524}\pm0.003$ & $\mathbf{0.612}\pm0.015$ & $0.133\pm0.047$ \\
\midrule
...
TIES                       & $\mathbf{0.737}\pm0.007$ & $0.520\pm0.014$ & $0.549\pm0.000$ & $0.234\pm0.000$ \\
$\thetab+$GD (ablation)      & $0.546\pm0.004$ & $0.373\pm0.013$ & $0.395\pm0.048$ & $0.011\pm0.064$ \\
$\thetab+$ungated (ablation) & $0.545\pm0.003$ & $0.398\pm0.009$ & $0.456\pm0.008$ & $0.066\pm0.055$ \\
$\thetab+$APR                & $0.692\pm0.036$ & $0.503\pm0.019$ & $\mathbf{0.565}\pm0.032$ & $0.062\pm0.051$ \\
\bottomrule
\end{tabular}
\end{table}
...
$\thetab+$GD (ablation)      & $0.579\pm0.014$ & $0.102\pm0.006$ & $0.568\pm0.014$ & $0.108\pm0.012$ \\
$\thetab+$ungated (ablation) & $0.602\pm0.005$ & $0.156\pm0.011$ & $0.578\pm0.003$ & $0.151\pm0.007$ \\
$\thetab+$APR                & $\mathbf{0.649}\pm0.020$ & $\mathbf{0.215}\pm0.066$ & $\mathbf{0.613}\pm0.056$ & $0.188\pm0.083$ \\
\bottomrule
\end{tabular}
\end{table}
...
APR dominates every checkpoint-only merge on both axes at once: it scores highest on the train tasks ($0.751$) and retains more held-out accuracy ($0.721$, a drop of $0.059$) than TIES ($0.711$), Breadcrumbs ($0.716$), task arithmetic ($0.695$) or DARE-TIES ($0.613$), at a third or less of their parameter displacement. The two ablations retain more still ($0.768$ and $0.738$), but they do so by barely moving---ordinary descent stays within $0.06$ of $\theta_0$ and scores $0.19$ less on the train tasks---so the frontier consists of $\theta_0$, GD and APR, and retention is cheap for a model that has not learned the tasks. What the ablations do show is that APR's retention is not a consequence of its labels alone: it gains $0.17$--$0.19$ train accuracy over both while giving up $0.02$--$0.05$ of held-out accuracy, whereas every merge gives up $0.06$--$0.17$ for a lower train score.
...
GD from base$^\ast$            & $0.06\pm0.00$ & $0.564\pm0.002$  & $\mathbf{0.768}\pm0.002\ (-0.012)$ \\
Ungated from base              & $0.37\pm0.06$ & $0.579\pm0.008$  & $0.738\pm0.009\ (-0.042)$ \\
...
TIES                           & $3.34\pm0.42$ & $0.735\pm0.006$  & $0.711\pm0.027\ (-0.069)$ \\
...
Replacing the loss by the held-out metric while keeping the $(\eta,S)$ grid produced ties: on $B/2$ held-out examples per task the mean metric moves in steps of one example in $8\cdot B/2$, and cells at different horizons reach the same value, so the tie-break was carrying a decision worth up to $0.1$ on GLUE-8 ($S\le20$ against $S=50$) while $S=5$ collapses at $\eta=32$ on CLIP-8. Fixing $S=50$, the horizon every well-behaved draw had selected, removes the axis along which the ties formed; $\eta$ is then selected on the metric with the normalized loss as the tie-break, and the merges use the same rule. On the diagnostic draws this reproduces every CLIP-8 selection of the loss rule and reduces GLUE-8's spread from $\pm0.11$ to $\pm0.02$.

\paragraph{Select-then-refit at $B=16$ on CLIP-8.}
The rule's one measured cost is the CLIP-8 $B=16$ cell of Table~\ref{tab:cv-v2}. Cells are built on $B/2=8$ examples per task and the winner is refit on $16$. On eight examples $\eta=32$ genuinely collapses on some draws---held-out accuracy $0.34$ with a normalized loss above $1$ on one fresh draw, Cars at zero for $\eta=64$ on another---so selection is right to reject it for the model it can see; on sixteen it is safe. Pinning $\eta=32$ with the full refit on the two fresh draws that rejected it scores $0.725$ and $0.732$ against their selected $0.675$ and $0.668$, and pinning $\eta=8$ on the draw that selected $32$ scores $0.677$ against $0.733$. Selection is therefore systematically conservative about $\eta$ at this budget, and here the held-out loss would have chosen better ($0.717\pm0.022$ against $0.692\pm0.036$, both below TIES's $0.737$): the two suites prefer different objectives, and the unified rule pays on this cell for the protection it buys on GLUE-8. Treating metric differences smaller than one held-out example as ties recovers about a third of the gap ($0.706\pm0.023$), changes one GLUE-8 selection for the better ($+0.005$ on the mean) and none elsewhere; we did not adopt it, because it was designed after seeing the fresh draws.
