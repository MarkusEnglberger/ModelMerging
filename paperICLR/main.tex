...
\paragraph{Baselines.}
Since selection is common to every method, baselines are tiered by what data \emph{constructs} the candidates being selected among, mirroring Section~\ref{sec:related}:
