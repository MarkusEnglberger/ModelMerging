...
% tuning, loss weighting, head-only recalibration, and replay fine-tuning are
% still to be run under split selection (extend scripts/labeled_baselines_n16.py
