...
\scriptsize
\setlength{\tabcolsep}{3.5pt}
\caption{\textbf{The experiment grid under split selection at a $16{+}16$ budget}, instantiated identically on every benchmark.
 Entries are mean aggregate with worst-task in parentheses: normalized retention on GLUE-8 and CLIP-8, where the pretrained \emph{alone} row is the zero point, and absolute accuracy on MergeBench and twenty-task CLIP, whose retention denominators degenerate (Section~\ref{sec:protocol}). MergeBench is run from the pretrained model only at this budget---generation-based scoring is the dominant cost there---and its composition tier is reported at $8{+}8$ in Table~\ref{tab:main8}; dashes: not run. $^{\dagger}$: the selected horizon is the longest offered ($S{=}50$ on the encoder tracks, $S{=}5$ on MergeBench).}
\label{tab:main16}
\renewcommand{\arraystretch}{0.95}
\begin{tabular}{llcccc}
\toprule
...
Pretrained      & alone      & $0$ & $0$ & $0.289\ (.06)$ & --- \\
                & $+$GD      & $-0.361\ ({-}3.52)$ & $-0.148\ ({-}1.04)$ & --- & --- \\
                & $+$ungated & $0.089^{\dagger}\ ({-}.31)$ & $-0.006\ ({-}.41)$ & --- & --- \\
                & $+$APR     & $0.223^{\dagger}\ ({-}.33)$ & $0.295^{\dagger}\ ({-}.45)$ & $0.378^{\dagger}\ (.27)$ & --- \\
\midrule
Task arithmetic & alone      & $0.320\ ({-}.18)$ & $0.270\ ({-}.53)$ & $0.470\ (.33)$ & --- \\
                & $+$GD      & $0.530\ ({+}.04)$ & $0.167^{\dagger}\ ({-}1.10)$ & --- & --- \\
                & $+$ungated & $0.529\ ({+}.03)$ & $0.241^{\dagger}\ ({-}.79)$ & --- & --- \\
                & $+$APR     & $0.498\ ({-}.18)$ & $0.462^{\dagger}\ ({-}.12)$ & $0.481^{\dagger}\ (.37)$ & --- \\
\midrule
Breadcrumbs     & alone      & $0.030\ ({-}2.14)$ & $0.431\ ({+}.08)$ & $0.417\ (.25)$ & --- \\
                & $+$GD      & $0.512\ ({-}.00)$ & $0.479^{\dagger}\ ({+}.04)$ & --- & --- \\
                & $+$ungated & $0.536\ ({+}.05)$ & $0.391^{\dagger}\ ({-}.40)$ & --- & --- \\
                & $+$APR     & $0.528\ ({-}.06)$ & $0.339^{\dagger}\ ({-}.46)$ & $0.412\ (.30)$ & --- \\
\midrule
DARE-TIES       & alone      & $0.301\ ({-}.34)$ & $0.364\ ({-}.32)$ & $0.490\ (.35)$ & --- \\
                & $+$GD      & $0.484\ ({-}.08)$ & $-1.273^{\dagger}\ ({-}4.87)$ & --- & --- \\
                & $+$ungated & $0.534\ ({+}.08)$ & $-0.578\ ({-}3.11)$ & --- & --- \\
                & $+$APR     & $\mathbf{0.576}\ ({+}.19)$ & $0.498^{\dagger}\ ({-}.31)$ & $0.495\ (.37)$ & --- \\
\midrule
TIES            & alone      & $0.208\ ({-}.22)$ & $0.525\ ({+}.21)$ & $0.464\ (.36)$ & --- \\
                & $+$GD      & $0.442\ ({-}.10)$ & $\mathbf{0.585}^{\dagger}\ ({+}.18)$ & --- & --- \\
                & $+$ungated & $0.442\ ({-}.07)$ & $0.318^{\dagger}\ ({-}1.57)$ & --- & --- \\
                & $+$APR     & $0.489^{\dagger}\ ({+}.01)$ & $0.566^{\dagger}\ ({-}.08)$ & $0.468\ (\mathbf{.38})$ & --- \\
\midrule
AdaMerging      & alone      & $0.028\ ({-}3.01)$ & $0.463\ ({-}.04)$ & $\mathbf{0.496}\ (.36)$ & --- \\
                & $+$GD      & $0.016\ ({-}2.95)$ & $0.502^{\dagger}\ ({-}.06)$ & --- & --- \\
                & $+$ungated & $0.466\ ({-}.10)$ & $0.285^{\dagger}\ ({-}1.41)$ & --- & --- \\
                & $+$APR     & $0.543\ ({+}.02)$ & $0.554^{\dagger}\ ({+}.15)$ & $0.495\ (.37)$ & --- \\
\midrule
RegMean         & alone      & --- & --- & --- & --- \\
                & $+$GD      & --- & --- & --- & --- \\
                & $+$ungated & --- & --- & --- & --- \\
