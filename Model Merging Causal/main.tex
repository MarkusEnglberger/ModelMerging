...
APR $\leftarrow$ calibrated merge         & $\mathbf{0.825}\ (\mathbf{0.543})$ & $\mathbf{0.662}\ (\mathbf{0.163})$ \\
\bottomrule
\end{tabular}
\end{table}
...
Ungated distance-scaled                   & $0.521^\S\ (-0.32)$ & $0.637\ (+0.18)$ \\
APR (proposed)                            & $0.598\ (+0.16)$ & $0.570^\S\ (+0.09)$ \\
Calibrated merge (per-tensor, labeled)    & $0.734^\S\ (+0.36)$ & $0.580\ (+0.02)$ \\
\textbf{APR $\leftarrow$ calibrated (proposed)} & $\mathbf{0.825}\ (+\mathbf{0.54})$ & $\mathbf{0.655}^\S\ (+0.03)$ \\
\bottomrule
\end{tabular}
\end{table}
